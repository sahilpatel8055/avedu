...
interface WhyOnlineProgramsSectionProps {
  universityName: string;
  lmsImagePath: string;
}

const WhyOnlineProgramsSection = ({ universityName, lmsImagePath }: WhyOnlineProgramsSectionProps) => {
  const points = [
    {
      number: "1",
      title: "Flexibility:",
      description: `${universityName} offers a flexible learning environment suitable for working professionals.`
    },
    {
      number: "2", 
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 max-w-7xl mx-auto">
          ...
          <div className="flex-1 lg:pr-8">
            <h2 className="text-3xl lg:text-4xl font-bold mb-8 leading-tight">
              Why <span className="text-red-600">Online Programs</span> From{" "}
              <span className="text-red-600">{universityName}</span> ?
            </h2>
              ...
              {points.map((point, index) => (
                <div key={index} className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <span className="text-5xl font-bold text-red-600 leading-none">
                      {point.number}
                    </span>
                  </div>
                  <div className="pt-2">
            ...
            <div className="relative">
              <img 
                ...
                onError={(e) => {
                  ...
                  target.src = '/assets/lms/common.png';
                }}
              />
            </div>
          </div>
...
export default WhyOnlineProgramsSection;