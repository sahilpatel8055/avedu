...
const CounselingForm: React.FC<CounselingFormProps> = ({ open, onOpenChange, onFormSubmit, onFormClose }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[92%] max-w-xl max-h-[95vh] p-0 bg-white mx-auto my-2 sm:my-4 overflow-hidden rounded-xl">
        <div className="grid grid-cols-1 h-full max-h-[95vh]">
          {/* Left Side - Form */}
