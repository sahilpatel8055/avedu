...
const categories: CourseCategory[] = [
  ...
  },
  {
    ...
    programs: 42,
    popularCourses: ["MA", "MA English", "MA Psychology", "Political science"],
    trending: false,
  },
  {
    id: "bba",
  ...
  },
  {
    ...
    icon: <Palette className="h-8 w-8" />,
    programs: 42,
    popularCourses: ["BA", "BA English", "BA Psychology", "Political science"],
    trending: false,
  },
];
      ...
      <CardContent className="p-3 sm:p-4 lg:p-6 text-center space-y-2 sm:space-y-3">
        <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-primary-light mx-auto flex items-center justify-center overflow-hidden group-hover:scale-110 transition-transform duration-300">
          {typeof category.icon === "string" ? (
            <img src={category.icon} alt={category.title} className="w-21 h-21 sm:w-30 sm:h-30 object-cover" loading="lazy" />
          ) : (
