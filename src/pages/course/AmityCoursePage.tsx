      ...
      <section className="py-16 bg-yellow-400 rounded-none">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Why Choose Amity University Online?</h2>
            <p className="text-lg text-muted-foreground">Key advantages of studying with Amity University Online.</p>
          </div>
