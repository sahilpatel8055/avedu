...
const MangalayatanCoursePage = () => {
  const { courseId } = useParams<{ courseId: string }>();
  // Using manipal course data for now - ideally would have separate mangalyatan data
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-4 mb-4">
                <img
                  src={mangalayatanLogo}
                  alt="Mangalayatan University Online Logo"
      ...
      <section className="py-16 bg-yellow-400 rounded-none">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Why Choose Mangalayatan University Online?</h2>
            <p className="text-lg text-muted-foreground">Key advantages of studying with Mangalayatan University Online.</p>
          </div>
...
export default MangalayatanCoursePage;